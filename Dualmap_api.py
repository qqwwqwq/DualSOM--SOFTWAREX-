"""
Unified Data Ingestion, DualSOM, and Sparse Autoencoder API.

This module provides a generic and robust interface for loading preprocessed datasets,
along with the low-level grid operations, K-Means clustering, and high-level DualSOM 
wrapper with the PyTorch-based Sparse Autoencoder for latent representation learning.
